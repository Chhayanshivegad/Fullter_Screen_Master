...
class _HomePageState extends State<HomePage> {
  String currentCategory = 'Italian';
  int currentMenu = 1;
  List<Product> dataProduct =
  products.where((element) => element.category == 'Italian').toList();
  List<IconData> menus = [
    Icons.home_rounded,
        ...
        builder:(context,snapshot){
          ...
          Future<void> deletefood(id) async {
            var response1 = await http.delete(Uri.parse(
                "https://631059cd826b98071a3ecc19.mockapi.io/food" +
                    id));
            return;
          }
          ;
